...
const makeCandidate = (
  ...
  const base = {
    candidateId: `c:${personId}:0`,
    personId, bounds: { minX: 0, minY: 0, maxX: 50, maxY: 12 },
    anchor: { x: 0, y: 0 }, rotation: 0, leaderLength: 0,
    family, validationStatus: "VALID" as const,
    rejectionReasons: Object.freeze([]), score: null,
    componentScores: undefined as Readonly<Record<string, number>> | undefined,
  };
  const merged = { ...base, ...overrides };
  return merged as LabelCandidate;
};
