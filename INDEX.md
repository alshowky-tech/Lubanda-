...
- `docs/architecture/milestone-3-architecture.md` — skeleton growth architecture.
...
- `docs/traceability/milestone-3-matrix.md` — Milestone 3 traceability.
- `docs/milestone-1-baseline-verification.md` — M1 baseline integrity verification.
